"""
Script to automatically reload roadmap data into MongoDB (no confirmation)
...
def main():
    print("=" * 60)
    print("Roadmap Data Auto-Reload Script")
    print("=" * 60)
    ...
    if existing_count > 0:
        print(f"\nDeleting {existing_count} existing CSV roadmaps...")
